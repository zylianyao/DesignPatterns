 ...
 * @since JDK 1.8
 */
public abstract class CrawlerArticle extends Crawler {

    public CrawlerArticle(String url) {
        super(url);
    }
    ...
    public void crawler() {
        ...
        System.out.println("爬取到文章的标题为：" + article.getTitle());
        System.out.println("爬取到文章的内容为：" + article.getHtmlContent());
